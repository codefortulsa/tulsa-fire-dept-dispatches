...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dispatches_station', (
        ...
        db.send_create_signal('dispatches', ['Station'])

        # Adding field 'Unit.station'
        db.add_column('dispatches_unit', 'station',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dispatches.Station'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Station'
        db.delete_table('dispatches_station')

        # Deleting field 'Unit.station'
        db.delete_column('dispatches_unit', 'station_id')
