...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnitFollower'
        db.create_table('dispatches_unitfollower', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dispatches.Unit'])),
            ('by_phone', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('by_email', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('dispatches', ['UnitFollower'])


    def backwards(self, orm):
        # Deleting model 'UnitFollower'
        db.delete_table('dispatches_unitfollower')
