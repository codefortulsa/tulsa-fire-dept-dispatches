...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Follower.phone_number'
        db.alter_column('dispatches_follower', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Follower.phone_number'
        db.alter_column('dispatches_follower', 'phone_number', self.gf('django.db.models.fields.TextField')())
