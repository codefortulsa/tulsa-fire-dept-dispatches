...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawDispatch.dispatch'
        db.alter_column('dispatches_rawdispatch', 'dispatch_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['dispatches.Dispatch']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RawDispatch.dispatch'
        raise RuntimeError("Cannot reverse this migration. 'RawDispatch.dispatch' and its values cannot be restored.")
